...
public class CheckCorrectSentAlign {
...
//			System.out.println(engDoc.getParts().size());
			...
			String base = "/users/yzcchen/chen3/ijcnlp2013/sentenceAlignCor/senAlignOut_modify/";
			ArrayList<String> alignContent = Common.getLines(base + i
					+ ".align");
			int chID = 0;
			int enID = 0;
