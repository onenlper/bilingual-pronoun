...
public class ZeroCorefTkTestEvaluate extends ZeroCoref {

	String folder;

	public ZeroCorefTkTestEvaluate(String folder) {
		super();
		this.folder = folder;
...
//						break;
	...
	public static void main(String args[]) {
		...
		ArrayList<String> probs = Common.getLines("mzeros.1.small.c");
		ArrayList<String> keys = Common.getLines("mzeros.1");
		...
		ZeroCorefTkTestEvaluate test = new ZeroCorefTkTestEvaluate(args[0]);
		test.getInstances();
