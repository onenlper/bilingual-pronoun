...
public class TrainCCMTAllDev {
	...
	static String engAlign = "/users/yzcchen/chen3/ijcnlp2013/googleMTALL/eng_MT/align/";
	static String chiAlign = "/users/yzcchen/chen3/ijcnlp2013/googleMTALL/chi_MT/align/";
	static String engDoc = "engCoNLL.train.4";
	static String mtEngDoc = "MT.engCoNLL.train.4";
	static String chiDoc = "chiCoNLL.train.4";
	static String mtChiDoc = "MT.chiCoNLL.train.4";

	static void loadV20() {
		engAlign = "/users/yzcchen/chen3/ijcnlp2013/wordAlignCor/align/";
		chiAlign = "/users/yzcchen/chen3/ijcnlp2013/wordAlignCor/align/";
		engDoc = "engCoNLL.train.2";
		mtEngDoc = "MT.engCoNLL.train.2";
		chiDoc = "chiCoNLL.train.2";
		mtChiDoc = "MT.chiCoNLL.train.2";
	}
	...
	static void loadV21() {
		...
		engDoc = "engCoNLL.train.3";
		mtEngDoc = "MT.engCoNLL.train.3";
		chiDoc = "chiCoNLL.train.3";
		mtChiDoc = "MT.chiCoNLL.train.3";
	}
