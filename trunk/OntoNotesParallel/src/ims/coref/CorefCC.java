...
public class CorefCC {
	...
	public static void main(String[] args) throws IOException,
		...
		// DocumentMap.loadRealBAAlignResult("/users/yzcchen/chen3/ijcnlp2013/googleMTRED/chi_MT/align/");
		...
		System.out.println(CorefCC.right);
		System.out.println(CorefCC.wrong);
		...
		ArrayList<String> engKeys = new ArrayList<String>(
				Parallel.engStat.keySet());
		...
		ArrayList<String> chiKeys = new ArrayList<String>(
				Parallel.chiStat.keySet());
...
//		Common.outputHashSet(Span.mappedChiMs, "goldParallelTestMapChiMention");
	}
