...
public class F_IsProperName extends AbstractEnumFeature<Bool>{
	private static final long serialVersionUID = 1L;

	private final TargetSpanExtractor tse;
	
	protected F_IsProperName(TargetSpanExtractor tse) {
		super(tse.ts.toString()+"ProperName", Bool.values());
		this.tse=tse;
	}
